...
const styles = StyleSheet.create({
  ...
  scrollView: { flex: 1, paddingHorizontal: 0, backgroundColor: COLORS.bg },
  ...
  sectionLabel: { fontSize: 11, fontWeight: '700', color: COLORS.textMuted, letterSpacing: 1.2, marginTop: 16, marginBottom: 4, paddingHorizontal: SCREEN.paddingHorizontal, paddingTop: 16, borderTopWidth: 1, borderTopColor: COLORS.border },
  card: { marginBottom: 0 },
